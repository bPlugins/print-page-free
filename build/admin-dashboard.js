...
/* harmony import */ var _Welcome__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Welcome */ "./src/bplugins-admin/Components/Welcome.js");
...
/* harmony import */ var _Settings__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Settings */ "./src/bplugins-admin/Components/Settings.js");
...
const App = props => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_router_dom__WEBPACK_IMPORTED_MODULE_1__.HashRouter, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_router_dom__WEBPACK_IMPORTED_MODULE_1__.Routes, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_router_dom__WEBPACK_IMPORTED_MODULE_1__.Route, {
    ...
    path: "settings",
    element: (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Settings__WEBPACK_IMPORTED_MODULE_10__["default"], {
      ...props
    })
...
const Settings = ({
  ...
  const {
    ...
    isLoading,
    error
  } = (0,_bpl_tools_hooks_useWPAjax__WEBPACK_IMPORTED_MODULE_2__["default"])('ppbSaveUninstallOption', {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (error) {
      setNotice((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Failed to save setting.', 'print-page'));
    }
  }, [error]);
  const handleToggle = () => {
    ...
    if (newValue) {
      const confirmed = window.confirm((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Are you sure? This will permanently delete all Print Page Block data (buttons, configurations, and settings) when the plugin is uninstalled.', 'print-page'));
      if (!confirmed) return;
    }
    setNotice('');
    saveData({
  ...
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Delete Data on Uninstall', 'print-page')), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('When enabled, all plugin data will be permanently deleted when you uninstall (delete) the plugin. This includes:', 'print-page')), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('All Print Page Button posts (print_page post type)', 'print-page')), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('All plugin settings and options', 'print-page'))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    className: "settingsWarning"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('⚠️ This action cannot be undone. Your data will be safe if you only deactivate the plugin.', 'print-page')), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, enabled ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Data will be deleted on uninstall', 'print-page') : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Data will be preserved on uninstall', 'print-page'))), notice && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
const Welcome = props => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_bpl_tools_Admin_Overview__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    ...props,
    limit: 1,
    loadMoreLabel: __('View More Changelogs', 'print-page')
...
const dashboardInfo = info => {
  ...
  return {
    ...
    changelogs: [{
      ...
      list: ['Added: Added uninstall data clean-up option in the admin settings dashboard to wipe plugin configurations on deletion.', 'Added: Added uninstall.php script to securely remove all custom post types and options if the cleanup setting is enabled.', 'Added: Added Gulp task configurations (gulpfile.js and package.json) to automate cross-platform release packaging.', 'Updated: Redesigned the shortcode copy-to-clipboard UI column in the print CPT admin table for a better user experience.', 'Updated: Migrated PHP class controllers directly under the includes/ directory and refactored code to use namespace PrintPage to comply with standard coding guidelines.', 'Improved: Unlocked previously locked pro fields in the Gutenberg editor and introduced a clean, non-intrusive notices UI to display premium feature requirements.', 'Fixed: Fixed multiple security issues flagged by WordPress Plugin Check (PCP), including direct access checks (ABSPATH), wp_unslash sanitization for AJAX, and translation string escaping for wp_die.']
    }, {
      type: 'fix',
      version: '1.2.8 - 03 May, 2026',
      list: ['Fixed: Fixed shortcode rendering & print button disappearing issue.']
    }],
    proFeatures: ['10 Exclusive Pro Button Styles', 'Advanced Print Options & Layouts', 'Elegant Modal-Based Print Preview', 'Enhanced Print Controls', 'Page Orientation Settings', 'Remove Specific Elements Before Print', 'Advanced Button Typography', 'Responsive Padding & Spacing', 'Dashed, Dotted & Double Borders', 'Button Shadow & Hover Effects'],
    startButton: {
      label: 'Start Now',
...
/* harmony import */ var _dashboard_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dashboard.scss */ "./src/bplugins-admin/dashboard.scss");
/* harmony import */ var _Components_App__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/App */ "./src/bplugins-admin/Components/App.js");
/* harmony import */ var _utils_data__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/data */ "./src/bplugins-admin/utils/data.js");
...
document.addEventListener('DOMContentLoaded', () => {
  const dashboardEl = document.getElementById('ppbCurrentBplDashboard');
